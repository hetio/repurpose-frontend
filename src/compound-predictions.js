...
export class CompoundPredictions extends Component {
  ...
  componentDidUpdate(prevProps) {
    if (
      this.props.compound &&
      !compareObjects(prevProps.compound, this.props.compound)
    ) {
      getPredictions(this.props.compound.compound_id).then((predictions) => {
...
async function getPredictions(id) {
  const predictions = await (await fetch(predictionsUrl + id + '.json')).json();
